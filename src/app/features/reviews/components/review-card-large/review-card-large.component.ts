...
@Component({
  selector: 'app-review-card-large',
  standalone: true,
  imports: [AvatarComponent, TranslatePipe],
  templateUrl: './review-card-large.component.html',
  styleUrl: './review-card-large.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ReviewCardLargeComponent {
  ...
  protected readonly relativeDateI18n = computed((): RelativeDateI18n => {
    ...
    const diffDays = Math.floor((Date.now() - createdAt.getTime()) / 86_400_000);
